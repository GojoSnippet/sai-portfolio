          ...
          <Col lg={6}>
            ...
            >
              <div className="mb-5">
                ...
                <p className="text-gray-400 lh-lg">
              ...
              <div className="d-flex flex-column gap-4">
                <a href={`mailto:${socialLinks.email}`} className="social-link">
                  ...
                  <div>
                    <p className="text-gray-500 small mb-0">Email</p>
                    <p className="text-white mb-0">{socialLinks.email}</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <p className="text-gray-500 small mb-0">LinkedIn</p>
                    <p className="text-white mb-0">Connect with me</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <p className="text-gray-500 small mb-0">GitHub</p>
                    <p className="text-white mb-0">Check my code</p>
                  </div>
                </a>
              </div>
            </motion.div>
            ...
            >
              <Form ref={formRef} onSubmit={handleSubmit} className="card-dark p-4 p-md-5">
                <Form.Group className="mb-4">
                  <Form.Label className="text-gray-400 small">Your Name</Form.Label>
                  <Form.Control
                    type="text"
                    name="name"
                    value={form.name}
                ...
                <Form.Group className="mb-4">
                  <Form.Label className="text-gray-400 small">Your Email</Form.Label>
                  <Form.Control
                    type="email"
                    name="email"
                    value={form.email}
                ...
                <Form.Group className="mb-4">
                  <Form.Label className="text-gray-400 small">Your Message</Form.Label>
                  <Form.Control
                    as="textarea"
                    name="message"
                    value={form.message}
